...
function gravaHistorico() {
    ...
    localStorage.setItem(ITEM_HISTORICO, JSON.stringify(historico)); // Confirmar o que faz JSON.stringify transforma em string
...
function carregaHistorico(){
    ...
    historico = JSON.parse(localStorage.getItem(ITEM_HISTORICO)) || []; // Confirmar o que faz JSON.parsef transforma em lista
